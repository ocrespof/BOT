...
const cmdAhorcado = {
  ...
  category: 'juegos', desc: 'Juega al ahorcado visual adivinando la palabra secreta (API Infinita)', cooldown: 5,
...
const cmdAdivinanza = {
  ...
  category: 'juegos', desc: 'Resuelve un acertijo dinámico extraído de una API pública.', cooldown: 5,
  run: async (client, m) => {
...
const cmdTrivia = {
  ...
  category: 'juegos', desc: 'Juega una trivia de cultura general de respuesta libre (API externa).', cooldown: 5,
  run: async (client, m, args) => {
...
const cmdWordle = {
  command: ['wordle'],
  category: 'juegos', desc: 'Juega al Wordle: adivina la palabra de 5 letras en 6 intentos.', usage: '.wordle [apuesta]', cooldown: 5,
  run: async (client, m, args) => {
