...
> _Gestión Grupal_
 ...
 ⊳ *${prefix}economy* ➭ Activar/desactivar economía RPG
...
> _RPG Virtual_
 ...
 ⊳ *${prefix}shop* ➭ 🏪 Tienda (Lootboxes, Títulos, Pociones)
 ⊳ *${prefix}buy* ➭ Comprar artículos
 ⊳ *${prefix}use* ➭ Usar consumibles e items
 ⊳ *${prefix}inventory* ➭ Ver tu mochila
 ⊳ *${prefix}trade* ➭ Intercambiar items raros
