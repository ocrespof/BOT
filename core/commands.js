...
> 🚀 *¡Hola, *@$sender*!*
> _Soy *$namebot*, tú asistente de Inteligencia Artificial.$cat_
...
⊳ *$prefix open* / *close* ➭ Tráfico de mensajes
⊳ *$prefix promote* / *demote* ➭ Gestión de rangos
⊳ *$prefix kick* ➭ Executar expulsión de usuario
⊳ *$prefix warn* / *delwarn* ➭ Sistema de advertencias
...
⊳ *$prefix options* ➭ Panel de ajustes avanzados`,
    ...
    main: `> ⚙️ *N Ú C L E O*
> _Comandos troncales de YukiBot_

⊳ *$prefix menu* ➭ Desplegar este panel
⊳ *$prefix ping* ➭ Chequeo de latencia del server
⊳ *$prefix status* ➭ Ver estado y métricas en vivo
⊳ *$prefix update* ➭ Sincronizar repositorio (*git pull*)
⊳ *$prefix restart* ➭ Reiniciar daemon de Node.js
⊳ *$prefix add* ➭ Interfaz para añadir plugins
⊳ *$prefix ex* ➭ Ejecución nativa de JavaScript
⊳ *$prefix clear* ➭ Purgar terminal de host`
}
